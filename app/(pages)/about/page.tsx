...
export default function About() {
  ...
  return (
    <div className=" container mx-auto">
      ...
      {/* Content */}
      <div className=" flex flex-col xl:flex-row justify-between gap-20 xl:gap-52 mx-12">
        {/* Developers */}
          ...
          <div className=" flex flex-col gap-8">
            <div className=" grid lg:grid-cols-2">
              <div className=" flex gap-8">
                ...
                />
                <div className=" flex flex-col my-2 h-full gap-4">
              ...
              <div className=" mx-2 lg:mx-0 my-4 lg:my-2 text-sm">CFO</div>
            </div>
            ...
            <div className=" grid lg:grid-cols-2">
              ...
              <div className=" mx-2 lg:mx-0 my-4 lg:my-2 text-sm">
        ...
        <div className=" flex flex-col gap-16 xl:max-w-md mb-40 xl:mb-0">
          ...
          <div className=" text-base">
            ...
            project is scraped from Nike Inc, so our website name is Nikia. This
            website was created using NextJS.
          </div>
