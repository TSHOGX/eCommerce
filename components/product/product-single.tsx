    ...
    <div className=" container mx-auto">
      <div className=" mx-auto w-fit my-20">
        <div className=" flex flex-col gap-12 lg:gap-20 lg:flex-row">
          <div className=" flex flex-row gap-3 lg:min-w-[556px]">
            <div className=" no-scrollbar flex flex-col gap-4 max-h-[450px] overflow-scroll">
          ...
          <div className=" flex flex-col gap-14 min-w-[350px] max-w-lg mb-20">
